...
Seurat_objects$processed<-seurat_flow(Seurat_objects$postQC,dim=1:21,sct=T,norm=F,umap="umap-learn") 
...
Seurat_objects[c("WT","KO")]<- llply(.data = Seurat_objects[c("WT","KO")], .fun =seurat_flow,res=.6,dim=1:21,sct=T,alg=1,umap="umap-learn",.parallel = T,.paropts = list(.packages = "Seurat"))
...
```{r}
   ...
   dataset.markers$processed<-FindAllMarkers(Seurat_objects$processed)
    ...
    ####rename cluster ####
cluster_ids$processed <- c("ss_MG","early_NP","int_homeo_MG","homeo_DAM","inflam_DAM","int_MG","int_NP","type_1_MF","CAM","homeo_MG","inflam_MG","inflam._NP","SC","MC","IR_MF","IR_DAM")
